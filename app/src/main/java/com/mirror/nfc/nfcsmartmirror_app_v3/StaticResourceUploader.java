...
public class StaticResourceUploader {
    ...
    public String uploadResource( final byte[] bytes,  final String urlBasePath, final ResourceRegistrationConfig registrationConfig)
            throws IOException {
        if (bytes == null) {
        ...
        return uploadResource(() -> new ByteArrayInputStream(bytes), urlBasePath, registrationConfig);
    }
